...
public class Houjiaozhang1 extends View {
    //坐标轴原点的位置
    ...
    private Handler mh=new Handler(){
        public void handleMessage(android.os.Message msg) {
            if(msg.what==0){                //判断接受消息类型
                Houjiaozhang1.this.invalidate();  //刷新View
            }
        };
    };
    public Houjiaozhang1(Context context, AttributeSet attrs) {
        super(context, attrs);
            ...
            public void run() {
                while(true){     //在线程中不断往集合中增加数据
                    ...
                    if (MainActivity.m_receive_data_down!=null) {
                        v = MainActivity.m_receive_data_down[25]+
